...
## [0.7.0](https://github.com/CQCL/tket2/compare/tket2-v0.6.0...tket2-v0.7.0) - 2024-12-02

### New Features

- [**breaking**] Track circuit extensions and read/write packages ([#680](https://github.com/CQCL/tket2/pull/680))
- [**breaking**] update measurement and alloc operations ([#702](https://github.com/CQCL/tket2/pull/702))

### Refactor

- [**breaking**] update to hugr 0.14 ([#700](https://github.com/CQCL/tket2/pull/700))
