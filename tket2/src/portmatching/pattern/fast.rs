...
impl pm::Pattern for CircuitPatternFast {
...
impl super::CircuitPattern for CircuitPatternFast {
...
mod tests {
    ...
    fn construct_pattern() {
        ...
        let p = CircuitPatternFast::try_from_circuit(&circ).unwrap();
    ...
    fn disconnected_pattern() {
        ...
        .unwrap();
        assert_eq!(
            CircuitPatternFast::try_from_circuit(&circ).unwrap_err(),
    ...
    fn pattern_with_copy(circ_with_copy: Circuit) {
        let pattern = CircuitPatternFast::try_from_circuit(&circ_with_copy).unwrap();
