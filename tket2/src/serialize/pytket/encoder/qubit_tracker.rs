...
pub struct QubitTracker<N> {
    ...
    qubit_to_reg: HashMap<Wire<N>, RegisterUnit>,
...
impl<N> Default for QubitTracker<N> {
    fn default() -> Self {
        Self {
            inputs: Default::default(),
            outputs: Default::default(),
            qubit_to_reg: Default::default(),
            seen_qubits: Default::default(),
            unit_generator: Default::default(),
        }
    }
}

impl<N: HugrNode> QubitTracker<N> {
    ...
    pub fn new(circ: &Circuit<impl HugrView<Node = N>>) -> Self {
        let mut tracker = QubitTracker::<N>::default();
    ...
    pub fn init_qubit(&mut self, wire: Wire<N>) -> &RegisterUnit {
    ...
    pub fn get(&self, wire: Wire<N>) -> Option<&RegisterUnit> {
    ...
    pub fn update(&mut self, wire: Wire<N>, updated_wire: Wire<N>) -> Option<&RegisterUnit> {
